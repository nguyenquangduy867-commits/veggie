                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="ltn__top-bar-menu">
                                <ul>
                                    <li><a href="locations.html"><i class="icon-placeholder"></i> Ngu Hanh Son, Ha Noi
                                            </a></li>
                                    <li><a href="mailto:minhdien.dev@gmail.com?Subject=Contact%20with%20to%20you"><i
                                                class="icon-mail"></i> nguyenquangduy867@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-5">
                                    ...
                                    <div class="ltn__main-menu">
                                        <ul>
                                            ...
                                            <li class="menu-icon"><a href="javascript:void(0)">Về chúng tôi</a>
                                                ...
                                                <li class="menu-icon"><a href="{{route('product.index') }}">Cửa hàng</a>
                                            </li>
                                            <li><a href="{{route('contact.index') }}">Liên hệ</a></li>
                                            <li class="special-link"><a href="{{route('contact.index') }}">NHẬN BÁO GIÁ</a></li>s
                                        </ul>
                                    </div>
                                </nav>
                            </div>
