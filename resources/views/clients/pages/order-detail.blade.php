...
<div class="ltn__shopping-cart-area mb-120">
 ...
 <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <img src="{{  $item->product->image_url}}" width="58">
                                                                    </td>
                                    ...
                                    <tbody>
                                        @foreach ($order->orderItems as $item)
                                            <tr>
                                                <td>{{ $item->product->name }}</td>
                                                <td>
                                                    <a href="{{ route('product.detail', ['slug' => $item->product->slug]) }}" class="btn theme-btn-1 btn-effect-1">
                                                        Đánh giá
                                                    </a>
                                                </td>
                                            </tr>
